document.getElementById("generateCertificateButton").addEventListener("click", function () {
    ...
    if (groomName.trim() === "" || brideName.trim() === "" || judgeName.trim() === "" || cityName.trim() === "" || brideImageInput.files.length === 0) {
        ...
        <div id="weddingCertificateContainer" class="position-relative mt-5 mb-5">
            ...
            <h1 class="weddingTitleColor custom-font-sloop-script">Certidã de Divorcio</h1>
            ...
            <h3 class="text-uppercase custom-font color-default text-center position-absolute custom-position">estão se divorciando
            </h3>
            ...
            <div class="w-100 d-flex align-items-center justify-content-center  ">
                ...
                <div class="w-50 text-center d-flex flex-column ml-3">
                    ...
                    <p class="color-default custom-font text-center">EX-Marido</p>
                </div>
                ...
                <div class="w-50 text-center d-flex flex-column mr-3">
                    ...
                    <p class="color-default custom-font text-center">EX-Esposa</p>
                </div>
    ...
    `;
            ...
            html2canvas(tempElement).then(function (canvas) {
                ...
                a.href = imgData;
                a.download = "certidao_divorcio.png";

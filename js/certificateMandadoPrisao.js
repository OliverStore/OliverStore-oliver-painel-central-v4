document.getElementById("generateCertificate").addEventListener("click", function () {
    ...
    if (imageInput.files.length === 0) {
        ...
        <div class="d-flex" id="mandadoPrisaoContainer">

            <div class="mandadoPrisao">
                
                <img class="bg_mandado_prisao" src="../img/mandado_de_prisao.png" alt="">
              
                <div class="informacoesMandadoPrisao">


                    <p class=" nome "> expedido por: ${ nome } </p>
                    <p class=" acusado "> Acusado: ${ nomeAcusado } - Portador do ID: ${id} </p>
                    <p class=" descricao "> ${ descricao } - ${id} </p>
    ...
    `;
            ...
            html2canvas(tempElement).then(function (canvas) {
                ...
                a.href = imgData;
                a.download = "Mandado de Prisão.png";
